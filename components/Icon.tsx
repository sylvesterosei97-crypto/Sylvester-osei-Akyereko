...
{/* FIX: Add missing icons for CallView and SendMediaView */}
export const EndCallIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={`h-6 w-6 ${props.className}`}>
        <path d="M12 9c-1.6 0-3.15.25-4.62.72v3.1c0 .47-.29.88-.73.99A8.13 8.13 0 0 1 3 12c0-4.42 3.58-8 8-8s8 3.58 8 8c0 .35-.02.69-.07.1a.996.996 0 0 0-.93-.9h-3.1c-.56-1.47-1.3-2.84-2.18-4.08C14.73 4.41 12.16 3.58 9.38 3.07 5.25 2.27 2.27 5.25 3.07 9.38c.51 2.78 1.34 5.35 2.84 7.54C7.89 19.33 9.61 21 12 21c.45 0 .88-.06 1.3-.18.44-.13.73-.55.73-1.01v-3.11c1.47-.47 2.84-1.12 4.09-2.03.1-.08.19-.17.28-.26.31-.31.5-.75.5-1.22 0-1.61-.25-3.15-.72-4.62h-3.1c-.47 0-.88-.29-1-.73A8.13 8.13 0 0 1 12 9z"/>
    </svg>
);

export const MuteIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={`h-6 w-6 ${props.className}`}>
        <path fillRule="evenodd" d="M12.001 2.25c-2.072 0-3.75 1.678-3.75 3.75v8.25c0 2.072 1.678 3.75 3.75 3.75s3.75-1.678 3.75-3.75V6c0-2.072-1.678-3.75-3.75-3.75zM4.5 10.5a.75.75 0 00-1.5 0v1.5a6.75 6.75 0 1013.5 0v-1.5a.75.75 0 00-1.5 0v1.5a5.25 5.25 0 11-10.5 0v-1.5z" clipRule="evenodd" />
        <path fillRule="evenodd" d="M3.554 4.614a.75.75 0 011.06 0l14.832 14.832a.75.75 0 11-1.06 1.06L3.554 5.674a.75.75 0 010-1.06z" clipRule="evenodd" />
    </svg>
);
...
export const VideoIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={`h-6 w-6 ${props.className}`}>
        ...
        <path d="M19.94 9.34l-2.12-1.21a.75.75 0 00-1.07.62v6.5a.75.75 0 001.07.62l2.12-1.21a.75.75 0 000-1.24z" />
    </svg>
);
...
export const CameraOffIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={`h-6 w-6 ${props.className}`}>
        <path d="M4.5 4.5a3 3 0 00-3 3v9a3 3 0 003 3h8.25a3 3 0 003-3v-9a3 3 0 00-3-3H4.5z" />
        <path d="M19.94 9.34l-2.12-1.21a.75.75 0 00-1.07.62v6.5a.75.75 0 001.07.62l2.12-1.21a.75.75 0 000-1.24z" />
        <path fillRule="evenodd" d="M2.93 2.93a.75.75 0 011.06 0l18 18a.75.75 0 11-1.06 1.06l-18-18a.75.75 0 010-1.06z" clipRule="evenodd"/>
    </svg>
);
